...
from build_operation_files import *
from build_test_files import *
from build_level_files import *
...
def main(args):
    ...
    params = (args.operation_name, args.object_types, args.parameter_types, args.dimensions)
    blis_path = Path(args.blis_directory).expanduser()

    print("Creating operation files")
    build_operation_files(blis_path, *params)
    print()
...
if __name__ == "__main__":
    ...
    python3 main.py ~/blis-copy/ -n trinv -o m -p ud -d m
    """
